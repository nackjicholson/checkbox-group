...
/***/ function(module, exports, __webpack_require__) {
	...
	var _statelessCheckbox = __webpack_require__(1);

	var _statelessCheckbox2 = _interopRequireDefault(_statelessCheckbox);
	  ...
	  var CheckboxGroup = function (_React$Component) {
	    ...
	    _createClass(CheckboxGroup, [{
	      ...
	      value: function _getCheckboxes() {
	        return [].concat(_toConsumableArray(_reactDom2.default.findDOMNode(this).querySelectorAll('input[type="checkbox"]')));
	      }
	    }, {
	      key: '_handleSelection',
	      value: function _handleSelection() {
	        var checkboxes = this._getCheckboxes();
	        var values = checkboxes.filter(function (checkboxNode) {
	          return checkboxNode.checked;
	        }).map(function (checkboxNode) {
	      ...
	      value: function render() {
	        ...
	        var checkboxConfig = { defaultValues: defaultValues, name: name, onChange: this._handleSelection.bind(this) };

	        return children((0, _statelessCheckbox2.default)(React, checkboxConfig));
	      }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function statelessCheckbox(React, config) {
	  ...
	  function StatelessCheckbox(props) {
	    var defaultChecked = (0, _lodash2.default)(defaultValues, props.value);
